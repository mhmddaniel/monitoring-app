    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <ul class="nav nav-tabs">
          ...
          <li><a href="<?php echo base_url();?>padmin/serapan" >Serapan</a></li>
          <li class="pull-right">
                          ...
                          <span class="text-success">
                            <h4  style="font-size:20px;padding-top: 10px;">
                              <?php if($_SESSION['level']=='admin'){ 
                                ...
                                echo "Rp ".number_format($csumpag['sumpagu']+$sumanggaran['angpagu']);
                              } else {
                                $bagian=$_SESSION['bagian'];
                                $sumpag=$this->m_padmin->sumpagu_bidang($kdph,$bagian);
                                $angpagu=$this->m_padmin->sumanggaran_bidang($kdph,$bagian);
                                $csumpag=$sumpag->row_array();
                                echo "Rp ".number_format($csumpag['sumpagu']+$angpagu['angpagu']);
                              } ?>
                            </h4>
                          </span>
                        </div>
                                ...
                                <button type="button" class="btn btn-box-tool dropdown-toggle" data-toggle="dropdown">
                                  ...
                                  <ul class="dropdown-menu" role="menu">
                                    ...
                                    if ($_SESSION['level']=='bidang'){
                                      ...
                                      <li class="divider"></li>
                                      <li><a href="<?php echo base_url().'padmin/data_awal/'.$proyek_id;?>"><span class="fa fa-book"></span>Data Awal</a></li>
                                      <li><a href="<?php echo base_url().'padmin/edit_proyek_jadwal/'.$proyek_id;?>"><span class="fa fa-pencil"></span>Edit Kontrak</a></li>
                                      <li><a href="<?php echo base_url().'padmin/get_proyek_bidang/'.$proyek_id;?>"><span class="fa fa-edit"></span>Progress</a></li>
                                      <li><a href="<?php echo base_url().'padmin/uplampiran/'.$proyek_id;?>"><span class="fa fa-plus"></span>Upload</a></li>
                                    <?php } else {}  ?>
                                  </ul>
                                </div>
                                <?php if($_SESSION['level']=='admin'){ ?>
