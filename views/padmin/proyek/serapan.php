                ...
                <div class="col-md-12">
                  <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <td>  <input type='text' id='tserap<?php echo $i; ?>' name="tserap[<?php echo $i; ?>]" class="form-control" onFocus="startCalc();"  onBlur="stopCalc();" /></td>
  ...
  <script type="text/javascript">
    ...
    function drawChart() {
      ...
      dataTable.addRows([
        ...
        ['<?php echo $m; ?>',  <?php echo $i['serapan_persen'];?>,  'Rp <?php echo number_format($i['serapan_target']);?>'],
      <?php endforeach; ?>
